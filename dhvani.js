...
const music= new Audio ('dhvani M/1.mp3');
// music.play();
...
const songs=[
    ...
    },
    {
        ...
        Poster:'dhvani I/12.jpg',
    },
    {
        id:'13',
        SongName:`Main Teri Hoon  <br />
        <div class="subtitle">Dhvani-Bhanushali</div>
      </h5>`,
        Poster:'dhvani I/13.jpg',
    },
    {
        id:'14',
        SongName:`Duniyaa <br />
...
masterPlay.classList.remove('bi-play-fill');
//DOWNLOAD MUSIC
download_music.href=`dhvani M/${index}.mp3`;
//CHANGE TITLE
let songTitle = songs.filter((els)=>{
  return els.id ==index;
})
